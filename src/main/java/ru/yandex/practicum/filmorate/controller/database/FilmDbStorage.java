...
public class FilmDbStorage implements FilmStorage {
    ...
    public List<Film> getFilms() {
        ...
        List<Integer> filmsId =
                jdbcTemplate.query("SELECT film_id FROM FILMS", ((rs, rowNum) -> rs.getInt("film_id")));
    ...
    private Set<Genre> getFilmGenresById(Integer id) {
    ...
    private Film mapRowToFilm(ResultSet rs, Set<Genre> genres, int id) throws SQLException {
        return new Film(rs.getInt("film_id"), rs.getString("name"),
                rs.getString("description"),
                rs.getDate("release_date").toLocalDate(),
                rs.getInt("duration"),
                new RatingMPA(rs.getInt("mpa_id"), rs.getString("title")),
